...
from rpch import RPCProxyClient, RPCProxyClientException, RPC_OVER_HTTP_v1, RPC_OVER_HTTP_v2
...
class SMBTransport(DCERPCTransport):
    ...
    def __init__(self, remoteName, dstport=445, filename='', username='', password='', domain='', lmhash='', nthash='',
                 aesKey='', TGT=None, TGS=None, remote_host='', smb_connection=0, doKerberos=False, kdcHost=None, userCert=None, certPass=None):
        DCERPCTransport.__init__(self, remoteName, dstport)
        self.__socket = None
        self.__tid = 0
        ...
        # changed from original impacket
            ...
            self.set_certificate(userCert, certPass)
    ...
    def connect(self):
        ...
        if self.__smb_connection == 0:
            ...
            # changed from original impacket
                ...
                self.__smb_connection.kerberosCertificateLogin(self._userCert, self._certPass)
